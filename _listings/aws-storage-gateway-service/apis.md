...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/reset/master/_listings/aws-storage-gateway-service/apis.md
...
- name: AWS Storage Gateway Service API - Reset Cache
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reset/master/_listings/aws-storage-gateway-service/actionresetcache-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reset/master/_listings/aws-storage-gateway-service/actionresetcache-get-openapi.md
x-common:
- type: x-api-gallery
